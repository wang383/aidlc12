...
> **版本**: V1.0
> **日期**: 2026-04-25
> **适用对象**: 需要在新项目中部署 demo-generator skill 的团队
...
在 Kiro 聊天窗口输入：
提示词需要包含关键字:Deeepsearch ,skill 描述。不要加入“生成skill”类似词语，这样会跳过brainstorm ,plan 等过程直接执行了。
...
```
plan demo-generator-prd-YYYY-MM-DD.md
```
...
```
execute plan demo-generator-plan-YYYY-MM-DD.md
```
